...
public class Buttons implements MouseListener {
    ...
    public Buttons(){
        ...
        for(int i=0; i<toolButton.length; i++){
            toolButton[i] = new JButton(new ImageIcon("img/icon/toolIcon" + i + ".jpg"));
    ...
    public void mouseClicked(MouseEvent e){
        ...
        if(btn == toolButton[0]){
            ...
            new ResizingPic(MenuBar.temp_imgPath);
        }
        ...
        if(btn == toolButton[5]){
            ...
            // var MouseListener = new MyMouseListener(){
                public void mousePressed(MouseEvent e){
                    clickBool= true;
                    starPoint.x = (e.getX() -(MenuBar.imgLabel.getWidth()-MenuBar.resizeWidth)/2)*MenuBar.ui_imgMag;
                    
                    starPoint.y =(e.getY() -(MenuBar.imgLabel.getHeight()-MenuBar.resizeHeight)/2)*MenuBar.ui_imgMag;
                }
                public void mouseReleased(MouseEvent e){
                    if(clickBool){
                        endPoint.x = (e.getX() -(MenuBar.imgLabel.getWidth()-MenuBar.resizeWidth)/2)*MenuBar.ui_imgMag;
                        endPoint.y = (e.getY() -(MenuBar.imgLabel.getHeight()-MenuBar.resizeHeight)/2)*MenuBar.ui_imgMag;
        ...
        if(btn == toolButton[6]){
            ...
            mouselistener = new MyMouseListener(){
                ...
                public void mouseDragged(MouseEvent e){ //점 저장
                    ...
                    Point tempPoint = new Point((e.getX() -(MenuBar.imgLabel.getWidth()-MenuBar.resizeWidth)/2)*MenuBar.ui_imgMag,
                    (e.getY() -(MenuBar.imgLabel.getHeight()-MenuBar.resizeHeight)/2)*MenuBar.ui_imgMag);
