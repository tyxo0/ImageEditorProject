...
public class SaturationEditor extends JFrame implements MouseListener {
    private int angle;
    ...
    public void change_Saturation(String b_Color, int delta_Satu) {
        try {
    ...
    public SaturationEditor(String file_addr){
        try {
            ...
            // 슬라이더 설정
            JSlider Saturation_slider = new JSlider();
            Saturation_slider.addMouseListener(this);
            Saturation_slider.setMinimum(-255);
            Saturation_slider.setMaximum(255);
            Saturation_slider.setValue(0);
            Saturation_slider.setOrientation(JSlider.HORIZONTAL);
            Saturation_slider.setMajorTickSpacing(50);
            Saturation_slider.setPaintTicks(true);
            Saturation_slider.setSize(450, 50);
            Saturation_slider.setLocation(110, 140);
            Saturation_slider.setForeground(Color.WHITE);
            Saturation_slider.setOpaque(false);
            this.add(Saturation_slider);
            ...
            // 텍스트용 레이블
            JLabel text_Label = new JLabel("채도 변경");
            ...
            Saturation_slider.addChangeListener(re -> {
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        change_Saturation(before_Color, release.getValue());
